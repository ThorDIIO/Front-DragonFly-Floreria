  ...
  const cards = [
    ...
    },
    {
      ...
      content: (
        <div className="p-6">
          <p className="text-gray-700 mb-4 text-lg">
            El uso de insecticidas y fertilizantes puede ser crucial para
            mantener tus plantas saludables y libres de plagas.
          </p>
          <h3 className="text-2xl font-bold mb-2">Consejos</h3>
          <ul className="list-disc pl-5 text-gray-700 text-lg">
            <li>Usa insecticidas naturales para evitar dañar la planta.</li>
            <li>
              Fertiliza tus plantas de acuerdo a sus necesidades específicas.
            </li>
            <li>
              Sigue siempre las instrucciones del producto para evitar
              sobredosis.
            </li>
          </ul>
        </div>

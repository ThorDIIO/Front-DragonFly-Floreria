...
<h2 className="text-4xl font-bold mb-4 text-pink-600 text-center lg:text-left-center">Por qué es importante el cuidado de las plantas</h2>
<br></br>
<br></br>
...
<h2 className="text-4xl font-bold mb-4 text-pink-600 text-center lg:text-left">Información sobre el cuidado de las plantas</h2>
...
<h3 className="text-2xl font-bold mb-4 text-center lg:text-left-center">Cuidado continuo y atención</h3>
...
<h2 className="text-4xl font-bold mb-4 text-pink-600 text-center lg:text-left-center">Insecticidas para plantas</h2>
<br></br>
<br></br>
<p className="text-lg text-gray-700 mb-4 text-center lg:text-left-center">
Los insecticidas para plantas son productos fitosanitarios diseñados para controlar plagas de insectos. Funcionan mediante la aplicación de sustancias químicas que afectan el sistema nervioso, respiratorio o digestivo de los insectos, causando su muerte o inhibiendo su capacidad reproductiva.

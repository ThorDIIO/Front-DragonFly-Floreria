...
export default function MostSelled() {
  ...
  const list: Product[] = [
    ...
    },
    {
      ...
      img: "/Orquideamorada1.jpeg",
      price: "S/.35.50",
      description: "Es conocida por su elegancia y belleza exótica, con pétalos grandes y simétricos que suelen aparecer en tonos vibrantes como el púrpura, el rosa y el blanco.",
    },
    {
      id: 3,
  ...
  return (
    <div className="flex items-center justify-center flex-col w-full gap-y-6">
      <div className="flex items-center w-full px-20">
        <hr className="w-full" />
        <h2 className="font-bold text-center w-1/2">Más vendidos</h2>
        <hr className="w-full" />
      </div>
